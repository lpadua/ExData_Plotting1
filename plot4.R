...
#plot 4 is a combination with plot 2 and 3 side by side with Voltage and Global Reactive Power
par(mfrow = c(2,2))

#plot 2 as first plot of first row
with(householdPC, plot(tstamp, Global_active_power, 
                       type = "l",
                       ylab = "Global Active Power (kilowatts)",
                       xlab = ""))

with(householdPC, plot(tstamp, Voltage, 
                       type = "l"))

#plot3 as first plot of second row
...
with(householdPC, plot(tstamp, Global_reactive_power, 
                       type = "l"))
